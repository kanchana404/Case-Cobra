            ...
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-center">
              ...
              <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
                ...
                <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                  Capture your favorite memories with your own,{' '}<span className="font-semibold">one-of-one</span> phone case. CaseCobra allows you to protext your memories,
                ...
                <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                  <div className="flex -space-x-4">
                    ...
                    width={500}
                    height={500}
                    className="inline-block h-10 w-10 rounded-full ring-2 ring-slate-100 object-hover"
                    />
                  </div>

                  <div className="flex flex-col justify-between items-center sm:items-start">
                    <div className="flex gap-0.5">
                      <Star className="g-4 w-4 text-green-600 fill-green-600" />
                      <Star className="g-4 w-4 text-green-600 fill-green-600" />
                      <Star className="g-4 w-4 text-green-600 fill-green-600" />
                      <Star className="g-4 w-4 text-green-600 fill-green-600" />
                      <Star className="g-4 w-4 text-green-600 fill-green-600" />
